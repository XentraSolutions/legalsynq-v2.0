...
public static class PermissionCodes
{
    ...
    public const string LienUsersView          = "SYNQ_LIENS.users:view";
    public const string LienUsersManage        = "SYNQ_LIENS.users:manage";
    public const string LienInvitationsManage  = "SYNQ_LIENS.invitations:manage";
    public const string LienRolesView          = "SYNQ_LIENS.roles:view";
    public const string LienRolesManage        = "SYNQ_LIENS.roles:manage";
    /// <summary>

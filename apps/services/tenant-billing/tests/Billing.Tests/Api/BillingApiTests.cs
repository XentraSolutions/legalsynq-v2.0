...
namespace Billing.Tests.Api;

public class BillingApiTests : IClassFixture<BillingWebApplicationFactory>
{
    private readonly BillingWebApplicationFactory _factory;

    public BillingApiTests(BillingWebApplicationFactory factory) => _factory = factory;

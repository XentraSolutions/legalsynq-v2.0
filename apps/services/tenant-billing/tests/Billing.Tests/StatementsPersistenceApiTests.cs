...
/// render/html, void).
/// </summary>
public class StatementsPersistenceApiTests : IClassFixture<BillingWebApplicationFactory>
{
    private readonly BillingWebApplicationFactory _factory;
    public StatementsPersistenceApiTests(BillingWebApplicationFactory factory) => _factory = factory;

...
/// </summary>
public class StatementTemplatesApiTests : IClassFixture<BillingWebApplicationFactory>
{
    private readonly BillingWebApplicationFactory _factory;
    public StatementTemplatesApiTests(BillingWebApplicationFactory factory) => _factory = factory;

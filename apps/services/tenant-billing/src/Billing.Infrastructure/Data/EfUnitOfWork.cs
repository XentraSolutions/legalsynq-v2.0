...
/// <summary>
/// EF Core-backed unit of work. Wraps the scoped <see cref="BillingDbContext"/>
...
public sealed class EfUnitOfWork : IUnitOfWork
{
    ...
    public EfUnitOfWork(BillingDbContext db) => _db = db;
    ...
    private sealed class EfRelationalTransaction : IUnitOfWorkTransaction
    {
        ...
        public EfRelationalTransaction(BillingDbContext db, IDbContextTransaction tx)
        {
            _db = db;
            _tx = tx;
        }

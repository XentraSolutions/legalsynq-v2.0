...
public interface ISynqLienAssistantSource
{
    ...
    Task<SynqLienCaseInsightsOutcome> GetCaseInsightsAsync(
        SynqLienCaseInsightsRequest request,
        CancellationToken ct = default);

    Task<SynqLienTaskSearchOutcome> SearchTasksAsync(
        SynqLienTaskSearchRequest request,
        CancellationToken ct = default);

    Task<SynqLienServicingSearchOutcome> SearchServicingAsync(
        SynqLienServicingSearchRequest request,
        CancellationToken ct = default);

    Task<SynqLienReportSummaryOutcome> GetReportSummaryAsync(
...
public sealed record SynqLienCaseSearchRequest(
    ...
    string? AccidentType = null,
    string? State = null,
    DateTime? OpenedFromUtc = null,
    DateTime? OpenedToUtc = null,
    string? DatePreset = null);
...
public sealed record SynqLienCaseInsightsRequest(
    Guid? CaseId,
    string? CaseNumber,
    string? DatePreset,
...
public sealed record SynqLienTaskSearchRequest(
    string? SearchText,
    string? Status,
    string? StatusGroup,
    string? Priority,
...
public sealed record SynqLienServicingSearchRequest(
    string? SearchText,
    string? Status,
    string? StatusGroup,
    string? Priority,
...
public sealed record SynqLienReportSummaryRequest(
    string? SearchText,
    string? CaseStatus,
    string? CaseStatusGroup,
    string? LienStatus,
    string? LienStatusGroup,
    string? LawFirm,
    string? CaseManager,
    string? CaseType,
    string? AccidentType,

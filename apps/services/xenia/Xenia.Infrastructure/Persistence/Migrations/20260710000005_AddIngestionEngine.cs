        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reply_to_addresses      = table.Column<string>(type: "text", nullable: true),
                    ...
                    processing_state        = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recipient_type  = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dispatch_status         = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_source_id                 = table.Column<string>(type: "char(36)", nullable: false),
                    provider_type                   = table.Column<int>(nullable: false),
                    cursor_type                     = table.Column<int>(nullable: false),

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    adapter_type = table.Column<string>(maxLength: 32, nullable: false),
                    name = table.Column<string>(maxLength: 200, nullable: false),
                    version = table.Column<string>(maxLength: 50, nullable: false),
                    configuration_status = table.Column<string>(maxLength: 32, nullable: false),
                    availability_status = table.Column<string>(maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "char(36)", nullable: false),
                    scope_type = table.Column<string>(maxLength: 32, nullable: false),

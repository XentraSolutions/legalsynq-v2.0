...
- When tool output contains *DisplayDate fields, use those display values in user-facing answers instead of recalculating from raw *Utc fields.
...
- When grounded data includes *DisplayDate fields, quote those display values exactly in user-facing answers instead of recalculating from raw *Utc fields.
- Treat date-only fields as exact calendar values: reproduce them verbatim and never apply a timezone conversion or shift the day.

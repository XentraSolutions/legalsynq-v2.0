...
namespace SynqComm.Infrastructure.Audit;
...
public sealed class AuditPublisher : IAuditPublisher
{
        ...
        string? metadata = null)
    {
        ...
        var request = new IngestAuditEventRequest
        {
            ...
            SourceSystem = "synqcomm-service",
            SourceService = "synqcomm-api",
            ...
            IdempotencyKey = IdempotencyKey.For(
                "synqcomm-service", eventType, entityId ?? tenantId.ToString(), now.UtcTicks.ToString()),
            Tags = ["synqcomm"],
        };

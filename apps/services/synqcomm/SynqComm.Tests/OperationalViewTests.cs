...
public class OperationalViewTests
{
    ...
    private static SynqCommDbContext CreateDb(string? name = null) =>
        TestHelpers.CreateDbContext(name ?? Guid.NewGuid().ToString());

    private static async Task<Conversation> SeedConversation(
        SynqCommDbContext db, string subject, string status = "Open", Guid? tenantId = null)
    {
    ...
    private static async Task<ConversationAssignment> SeedAssignment(
        SynqCommDbContext db, Guid conversationId, Guid? assignedUserId, Guid? queueId = null, string status = "Assigned")
    {
    ...
    private static async Task<ConversationSlaState> SeedSla(
        SynqCommDbContext db, Guid conversationId, string priority = "Normal",
    ...
    private static async Task SeedMention(
        SynqCommDbContext db, Guid conversationId, Guid mentionedUserId, Guid? messageId = null)
    {
    ...
    private static async Task SeedReadState(
        SynqCommDbContext db, Guid conversationId, Guid userId, bool isRead = true)
    {
    ...
    private static async Task SeedMessage(
        SynqCommDbContext db, Guid conversationId, string body)
    {
    ...
    private static async Task<ConversationQueue> SeedQueue(SynqCommDbContext db, string name = "Support")
    {

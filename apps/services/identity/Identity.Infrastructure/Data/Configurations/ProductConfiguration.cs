...
public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.HasData(
            ...
            new { Id = SeedIds.ProductXenia,           Name = "Xenia",           Code = "XENIA",            Description = (string?)"Enterprise intelligence platform for LegalSynq products.", IsActive = true, CreatedAtUtc = SeedIds.SeededAt },

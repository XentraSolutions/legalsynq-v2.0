...
public class PermissionConfiguration : IEntityTypeConfiguration<Permission>
{
    public void Configure(EntityTypeBuilder<Permission> builder)
    {
        ...
        builder.HasData(
            ...
            new { Id = SeedIds.PermLienUserRead,         ProductId = sl, Code = "SYNQ_LIENS.user:read",          Name = "Read SynqLien Users",         Description = (string?)"View tenant users with SynqLien access or invitations", Category = (string?)"User Management", IsActive = true, CreatedAtUtc = at, UpdatedAtUtc = (DateTime?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { Id = SeedIds.PermLienUserInvite,       ProductId = sl, Code = "SYNQ_LIENS.user:invite",        Name = "Invite SynqLien Users",       Description = (string?)"Invite users into SynqLien", Category = (string?)"User Management", IsActive = true, CreatedAtUtc = at, UpdatedAtUtc = (DateTime?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { Id = SeedIds.PermLienUserAccessManage, ProductId = sl, Code = "SYNQ_LIENS.user_access:manage", Name = "Manage SynqLien User Access", Description = (string?)"Grant or revoke SynqLien product access", Category = (string?)"User Management", IsActive = true, CreatedAtUtc = at, UpdatedAtUtc = (DateTime?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { Id = SeedIds.PermLienUserRoleAssign,   ProductId = sl, Code = "SYNQ_LIENS.user_role:assign",   Name = "Assign SynqLien User Roles",  Description = (string?)"Replace direct SynqLien role assignments", Category = (string?)"User Management", IsActive = true, CreatedAtUtc = at, UpdatedAtUtc = (DateTime?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },
            new { Id = SeedIds.PermLienUserAuditRead,    ProductId = sl, Code = "SYNQ_LIENS.user_audit:read",   Name = "Read SynqLien User Audit",    Description = (string?)"View SynqLien user-management audit events", Category = (string?)"User Management", IsActive = true, CreatedAtUtc = at, UpdatedAtUtc = (DateTime?)null, CreatedBy = (Guid?)null, UpdatedBy = (Guid?)null },

...
public class ProductRoleConfiguration : IEntityTypeConfiguration<ProductRole>
{
    public void Configure(EntityTypeBuilder<ProductRole> builder)
    {
        ...
        builder.HasData(
            ...
            new { Id = SeedIds.PrSynqLienUserAdmin,       ProductId = SeedIds.ProductSynqLiens,       Code = "SYNQLIEN_USER_ADMIN",       Name = "SynqLien User Administrator", Description = (string?)"Tenant-scoped administration of SynqLien users, invitations, access, and roles", IsActive = true, CreatedAtUtc = SeedIds.SeededAt },

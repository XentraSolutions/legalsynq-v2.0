...
namespace Intake.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260814032908_AddGenericClassification")]
    partial class AddGenericClassification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Intake.Domain.Classification.ClassificationProfileDefinition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "DOCUMENT_TYPE_V1",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Generic artifact/document type classification only; no business-field extraction.",
                            DisplayName = "Generic Document Type V1",
                            IsActive = true,
            ...
            modelBuilder.Entity("Intake.Domain.Classification.ClassificationTaxonomyDefinition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "DOCUMENT_TYPE",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            DisplayName = "Generic Document Type",
                            IsActive = true,
                            IsSystemDefined = true,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 1

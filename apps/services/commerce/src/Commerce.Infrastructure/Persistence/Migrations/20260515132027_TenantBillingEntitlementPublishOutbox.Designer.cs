...
namespace Commerce.Infrastructure.Persistence.Migrations
{
    ...
    partial class TenantBillingEntitlementPublishOutbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commerce.Domain.AccountStanding.AccountStanding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("account_standings", (string)null);
                });
            ...
            modelBuilder.Entity("Commerce.Domain.Invoicing.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Commerce.Domain.Invoicing.InvoiceBranding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("invoice_branding", (string)null);
                });

            modelBuilder.Entity("Commerce.Domain.Invoicing.InvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("SubscriptionItemId")
                        .HasDatabaseName("ix_invoice_lines_subscription_item_id");

                    b.ToTable("invoice_lines", (string)null);
                });

            modelBuilder.Entity("Commerce.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Commerce.Domain.Payments.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("BillingAccountId")
                        .HasDatabaseName("ix_payment_attempts_billing_account_id");
            ...
            modelBuilder.Entity("Commerce.Infrastructure.Integration.TenantBilling.Outbox.TenantBillingEntitlementPublishOutboxRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("tenant_billing_entitlement_publish_outbox", (string)null);
                });
            ...
            modelBuilder.Entity("Commerce.Domain.Invoicing.InvoiceLine", b =>
                {
                    b.HasOne("Commerce.Domain.Invoicing.Invoice", null)
                        .WithMany()
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Commerce.Domain.Subscriptions.SubscriptionItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Commerce.Domain.Payments.PaymentAttempt", b =>
                {
                    ...
                    b.HasOne("Commerce.Domain.Payments.Payment", null)
                        .WithMany()

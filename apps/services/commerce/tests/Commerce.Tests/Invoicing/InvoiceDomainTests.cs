...
public class InvoiceDomainTests
{
    ...
    {
        var inv = Invoice.Create(Guid.NewGuid(), null, "INV-1", "usd", Now, Now.AddDays(7),
    ...
    {
        Action a = () => Invoice.Create(Guid.NewGuid(), null, "INV-1", "USDX", Now, null,
            InvoiceStatus.Open, Now);
    ...
    {
        Action a = () => Invoice.Create(Guid.NewGuid(), null, "INV-1", "USD", Now, null,
    ...
    {
        var line = InvoiceLine.Create(Guid.NewGuid(), null, "Seat", 3, 1500, "USD", null, null, Now);
    ...
    {
        Action a = () => InvoiceLine.Create(Guid.NewGuid(), null, "Seat", 1, 1000, "USD",
    ...
    {
        var inv = Invoice.Create(Guid.NewGuid(), null, "INV-1", "USD", Now, null,
            InvoiceStatus.Open, Now);

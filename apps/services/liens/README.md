...
| `GET`  | `/api/liens/selling/liens?tab=pending\|internal\|sold\|archived\|all`     | Returns the same seller-scoped, filtered, paginated lien rows without dashboard totals. Each row includes the lien creation timestamp as `createdAtUtc`. Approval-stage rows remain searchable in the Pending tab, Archived rows remain searchable in the Archived tab, and Accepted liens remain searchable in the Sold tab.                                                                                                                                                                                                    |

...
`POST /api/liens/cases/liens-updates/v3` excludes case-level **Case Details Update** history without a lien association. Those records remain in `case-updates/v3`; every Liens Updates row represents a specific lien and includes its lien ID and action.

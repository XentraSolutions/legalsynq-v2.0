...
| `GET`           | `/api/liens/settlement/reductions/case/{caseId}`                                                    | Returns only the latest reduction for each lien in the tenant-scoped case, ordered by reduction date and creation time. Historical reduction rows remain available through the lien-specific reduction endpoint and settlement history APIs.                                                                                                                                                                                                                                                                                                                             |

...
namespace Liens.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260626000001_AddFundingCompanyAndLeadContactTypes")]
    public partial class AddFundingCompanyAndLeadContactTypes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($"""
                ...
                FROM (
                    SELECT 'FundingCompany' AS Code, 'Funding Company' AS Name, 'Funding company contact' AS Description, 6 AS Sort UNION ALL
                    SELECT 'Lead',                 'Lead',                  'Lead or referral source contact',       7
                ) AS s
                WHERE NOT EXISTS (
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                WHERE `TenantId` IS NULL
                  ...
                  AND `Code` IN ('FundingCompany', 'Lead');
                """);
        }
    }
}

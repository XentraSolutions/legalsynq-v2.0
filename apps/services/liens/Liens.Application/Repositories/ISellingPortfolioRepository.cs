...
public interface ISellingPortfolioRepository
{
    ...
    Task<List<SellingPortfolioActivity>> GetActivityAsync(Guid tenantId, Guid portfolioId, CancellationToken ct = default);
    ...
    Task AddActivityAsync(SellingPortfolioActivity activity, CancellationToken ct = default);
}

    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AddressState = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                AddressPostalCode = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),

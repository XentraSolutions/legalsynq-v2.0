...
/// </summary>
public class InvoicesTemplateStampingApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;
    public InvoicesTemplateStampingApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

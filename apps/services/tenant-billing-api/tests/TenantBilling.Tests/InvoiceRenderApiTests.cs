...
/// </summary>
public class InvoiceRenderApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;
    public InvoiceRenderApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

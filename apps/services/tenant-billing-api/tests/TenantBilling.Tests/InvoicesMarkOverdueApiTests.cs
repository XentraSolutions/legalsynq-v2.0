...
/// </summary>
public class InvoicesMarkOverdueApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;

    public InvoicesMarkOverdueApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

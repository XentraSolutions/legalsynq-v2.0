...
/// </summary>
public class InvoiceCreationDefaultDueDaysApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;
    public InvoiceCreationDefaultDueDaysApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

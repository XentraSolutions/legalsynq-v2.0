...
/// </summary>
public class InvoiceTemplatesTenantApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;
    public InvoiceTemplatesTenantApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

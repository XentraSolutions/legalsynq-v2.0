...
/// </summary>
public class CustomerStatementApiTests : IClassFixture<TenantBillingWebApplicationFactory>
{
    private readonly TenantBillingWebApplicationFactory _factory;
    public CustomerStatementApiTests(TenantBillingWebApplicationFactory factory) => _factory = factory;

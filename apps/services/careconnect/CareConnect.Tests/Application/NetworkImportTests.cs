    ...
    public async Task ImportProvidersAsync_Execute_CreatesProviderAndMembership()
    {
        ...
        parser.Setup(p => p.ParseAsync(It.IsAny<Stream>(), "providers.csv", It.IsAny<CancellationToken>()))
            .ReturnsAsync(new ProviderImportParseResult(
                ...
                1,
                [
                    new ProviderImportParsedRow(2, "row-2", tenantId.ToString(), "Jane", "Smith", "Smith Family Practice", "1234567890", "Jane@Example.com", "555-0100", "123 Main St", "Chicago", "il", "60601", "yes", "no")
                ]));
    ...
    public async Task ImportProvidersAsync_DryRun_DoesNotWrite()
    {
        ...
        parser.Setup(p => p.ParseAsync(It.IsAny<Stream>(), "providers.csv", It.IsAny<CancellationToken>()))
            .ReturnsAsync(new ProviderImportParseResult(
                "providers.csv",
                1,
                [new ProviderImportParsedRow(2, "row-2", tenantId.ToString(), "Jane", "Smith", null, null, "jane@example.com", "555-0100", "123 Main St", "Chicago", "IL", "60601", null, null)]));
    ...
    public async Task ImportProvidersAsync_ReusesByNpiAndMarksAlreadyInNetwork()
    {
        ...
        parser.Setup(p => p.ParseAsync(It.IsAny<Stream>(), "providers.csv", It.IsAny<CancellationToken>()))
            .ReturnsAsync(new ProviderImportParseResult(
                "providers.csv",
                1,
                [new ProviderImportParsedRow(2, "row-2", tenantId.ToString(), "Jane", "Smith", null, "1234567890", "jane@example.com", "555-0100", "123 Main St", "Chicago", "IL", "60601", null, null)]));
    ...
    public async Task ImportProvidersAsync_InvalidBoolean_FailsRowWithoutWriting()
    {
        ...
        parser.Setup(p => p.ParseAsync(It.IsAny<Stream>(), "providers.csv", It.IsAny<CancellationToken>()))
            .ReturnsAsync(new ProviderImportParseResult(
                "providers.csv",
                1,
                [new ProviderImportParsedRow(2, "row-2", tenantId.ToString(), "Jane", "Smith", null, null, "jane@example.com", "555-0100", "123 Main St", "Chicago", "IL", "60601", "maybe", null)]));

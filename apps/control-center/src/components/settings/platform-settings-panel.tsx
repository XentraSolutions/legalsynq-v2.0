  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-lg px-5 py-4">
        ...
        <div>
          <p className="text-sm font-medium text-blue-800">Timestamps displayed in UTC</p>
          <p className="text-xs text-blue-700 mt-0.5">
            Control Center always displays all dates and timestamps in UTC for consistency across platform operators.
            Per-tenant timezone configuration is managed in each tenant's own settings.
          </p>
        </div>
      </div>

  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      {currentGroups.length > 0 ? (
        ...
        <p className="px-5 py-4 text-sm text-gray-400 italic">No group memberships.</p>
      )}
      ...
      {groupsToAdd.length > 0 && (
        <div className="px-5 py-3 border-t border-gray-100 bg-gray-50 flex items-end gap-3 flex-wrap">
          ...
          {addOk && <span className="text-xs text-green-700 font-medium">Added to group.</span>}
        </div>
      )}

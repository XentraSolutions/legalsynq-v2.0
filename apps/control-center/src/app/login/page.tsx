...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative overflow-hidden bg-[#060d1b]">

      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(79,70,229,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(79,70,229,0.03)_1px,transparent_1px)] bg-[size:48px_48px]" />
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-indigo-500/[0.04] blur-[120px]" />
        <div className="absolute bottom-[-15%] left-[-5%] w-[500px] h-[500px] rounded-full bg-indigo-600/[0.03] blur-[100px]" />
      </div>
      ...
      <div className="hidden lg:flex lg:w-[48%] xl:w-[44%] flex-col justify-between p-10 xl:p-14 relative z-10">
        ...
        <div className="py-8">
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <span className="text-[11px] font-semibold text-indigo-400 tracking-[0.15em] uppercase">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={label} className="flex items-center gap-3.5 group">
                <div className="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center shrink-0 group-hover:bg-white/[0.06] transition-colors">
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-screen lg:min-h-0 px-6 py-12 relative z-10">
        ...
        <div className="w-full max-w-[400px]">
          ...
          {reason === 'unauthorized' && (
            <div role="alert" className="mb-5 bg-amber-500/10 border border-amber-500/20 rounded-lg px-4 py-3 text-sm text-amber-300">
          ...
          {reason === 'unauthenticated' && (
            <div role="alert" className="mb-5 bg-white/[0.04] border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-slate-400">
        ...
        <div className="lg:hidden mt-12 text-center text-[11px] text-slate-500">
          <span>&copy; {new Date().getFullYear()} LegalSynq</span>

...
/**
 * / — Control Center admin dashboard landing page.
 *
 * Public health-check + quick-nav into all platform sections.
 * All linked pages still enforce requirePlatformAdmin() at the page level.
 */
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="mb-8 text-center space-y-2">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 border border-green-200">
          ...
          <span className="text-sm font-medium text-green-700">Running on port 5004</span>
        </div>
      </div>
...
function NavLink({
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0 text-gray-300 group-hover:text-indigo-400 transition-colors text-sm ml-3">→</span>
    </Link>
  );
}

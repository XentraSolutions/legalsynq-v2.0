...
import { InfiniteOptions } from "./use-filter-options";
 ...
 */
export function usePortfolio(query: any) {
  return useQuery({
    queryKey: ["portfolio"],
    queryFn: () => liensService.getLiens({}),
    staleTime: 30_000,
    retry: false,
  });
}
 ...
 */
export function useMedicalFacilityByFacilityId(
...
export function useLienStatusOptions(opts?: {
  enabled?: boolean;
}): InfiniteOptions {

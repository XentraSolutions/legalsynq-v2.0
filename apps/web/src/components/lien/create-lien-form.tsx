...
export function CreateLienForm() {
  ...
  function validate(): boolean {
    ...
    else if (parseFloat(originalAmount) <= 0)
      errs.originalAmount = "Must be greater than zero";
    setFieldErrors(errs);
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        if (err.isForbidden) {
          setError("You do not have permission to create liens.");
          return;
        }
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setFieldErrors((fe) => ({ ...fe, originalAmount: "" }));
              }}
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Subject party identity will be hidden from marketplace buyers
      ...
      <div className="bg-white border border-gray-200 rounded-lg px-5 py-5">
        ...
        <p className="text-xs text-gray-400 mb-4">
          ...
          {isConfidential &&
            " This information will not be visible to buyers until purchase."}
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">

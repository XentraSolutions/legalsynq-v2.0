...
export function CaseTaskManager({
  caseId,
  workflowStageId,
}: CaseTaskManagerProps) {
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-100">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-2.5 text-left text-[10px] font-medium text-gray-500 uppercase tracking-wide">
                    Title
                  </th>
                  <th className="px-4 py-2.5 text-left text-[10px] font-medium text-gray-500 uppercase tracking-wide">
                    Status
                    ...
                    >
                      <td className="px-4 py-2">
                        <div className="flex items-center gap-2">
                          <i
                            className={`${TASK_PRIORITY_ICONS[task.priority]} text-xs ${TASK_PRIORITY_COLORS[task.priority]}`}
                          />
                      ...
                      <td className="px-4 py-2">
                        <span
                          className={`text-[10px] font-medium ${TASK_PRIORITY_COLORS[task.priority]}`}
                        >
                      ...
                      <td className="px-4 py-2">
                        <span
                          className={`text-[10px] ${isOverdue(task.dueDate, task.status) ? "text-red-600 font-medium" : "text-gray-400"}`}
                        >
                          <DateDisplay
                            value={task.dueDate}
                            format="date"

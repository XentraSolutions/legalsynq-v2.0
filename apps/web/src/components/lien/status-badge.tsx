...
export function StatusBadge({ status, label, size = "sm" }: StatusBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full border font-medium ${sizeClass} ${style}`}
    >
      {resolvedLabel}
    </span>
  );

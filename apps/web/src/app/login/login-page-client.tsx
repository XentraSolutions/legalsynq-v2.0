...
function TenantLogo() {
  ...
  if (branding.logoDocumentId)
    sources.push({
      url: `/api/branding/logo/${branding.logoDocumentId}`,
      isWhite: false,
    });
  if (branding.logoWhiteDocumentId)
    sources.push({
      url: `/api/branding/logo/${branding.logoWhiteDocumentId}`,
      isWhite: true,
    });
  if (branding.logoUrl) sources.push({ url: branding.logoUrl, isWhite: false });
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className="relative z-10 py-12">
          ...
          >
            For medical providers, specialists, and law firm partners
            coordinating care
          </p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span
              className="text-[10px]"
              style={{ color: "rgba(186,230,253,0.2)" }}
            >
              &bull;
            </span>
            <Link
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="mt-1.5 text-sm text-gray-500">
              Sign in to your CareConnect portal
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-screen lg:min-h-0 px-6 py-12 bg-gray-50">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1.5 text-sm text-gray-500">
              Sign in to your LegalSynq account
            </p>
          </div>

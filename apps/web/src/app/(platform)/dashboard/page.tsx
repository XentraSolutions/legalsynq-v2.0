...
function ProductCard({
  ...
  return (
    <div className="relative flex h-full flex-col rounded-xl border border-gray-200 bg-white p-6 hover:shadow-md hover:border-gray-300 transition-all">
      {meta.iconSrc ? (
        <img
          src={meta.iconSrc}
          alt=""
      ...
      {items.length > 0 ? (
        ...
        <>
          {/* Covers the whole card so it's clickable, not just the arrow. */}
          <Link
            href={primaryHref}
          ...
          <div className="mt-4 flex flex-1 items-end justify-end">
            <Button variant="icon-rounded" tabIndex={-1} className="pointer-events-none">
